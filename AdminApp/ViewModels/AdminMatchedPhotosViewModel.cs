...
{
    public class AdminMatchedPhotosViewModel : BaseViewModel
    {
        private long totalPageSize = 0;
        private int records = 0;

        public AdminMatchedPhotosViewModel()
        {
            GetMatchedPhotos();
        }
        ...
        private async void PreviousButton()
        {
            ...
            if (PageNo >= 1)
            {
                ...
                if (response.IsValidated)
                {
                    ...
                    List<MatchedPhotosResponseModel> list = JsonConvert.DeserializeObject<List<MatchedPhotosResponseModel>>(response.Data);
